function output = model_gambLearn_mixture_partial(x,data)

% Reinforcement learning model with mixture policy and partial Updating
%
...
w_gamb = x(4); %mixure proportion for gambling task
p = x(5); %perseveration

info = [data.info];

C = 3; % number of all options (third option = nochoice\miss)
