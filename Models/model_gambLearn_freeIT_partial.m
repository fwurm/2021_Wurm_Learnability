function output = model_gambLearn_freeIT_partial(x,data)

% Reinforcement learning model with variable inverse temperature and partial updating
%
...
b_learn = x(2); %inverse temperature
b_gamb = x(3); %inverse temperature
p = x(4);
